...
?>
    ...
    <head>
        ...
        .navbar-default .navbar-nav > li > a:not(.btn) {
            ...
            opacity: 1;
            color: #000000; /* Ganti dengan warna hitam (#000000) */
            margin-top: 18px;
        }
    ...
    <body>
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" color-on-scroll="200">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="dashboard.php" class="navbar-brand" style="color: #000000;">
                        LOWKER.ID
                    </a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-user-circle" style="font-size: 18px;"></i> Hallo, <?php echo $_SESSION['calon_pekerja_nama_lengkap'];?> <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="profil_edit.php">Edit Profil</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="../php/logout.php"><i class="fa fa-sign-out"></i> Keluar</a></li>
                            </ul>
                        </li>
                    </ul>
