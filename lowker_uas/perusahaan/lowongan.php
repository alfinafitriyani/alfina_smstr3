                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <span class="icon-bar bar3"></span>
                            ...
                            <a class="navbar-brand" href="#" style="font-weight: 800;">LOWKER.ID</a>
                        </div>
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-left" style="margin-left: 56px;">
                                <li class="active"><a href="lowongan.php">Lowongan</a></li>
                                <li><a href="lowongan_tambah.php">Tambah Lowongan</a></li>
                                <li><a href="#" data-toggle="modal" data-target="#search">Cari Lowongan</a>
                                    <!-- Modal Search -->
